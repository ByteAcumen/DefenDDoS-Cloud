...
import { Shield, Mail, Lock, Eye, EyeOff, ArrowRight, AlertCircle, Loader2, Github } from 'lucide-react';
...
export default function LoginPage() {
    ...
    // Clear errors and set focus on mount
    useEffect(() => {
        clearError();
        setFocus('email');
    }, [clearError, setFocus]);
    ...
    // Show authentication required message if redirected
    const authRequired = searchParams?.get('error') === 'authentication_required';
                ...
                >
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                        <button
                            ...
                            className="flex items-center justify-center gap-2 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all duration-200 text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    disabled={isSubmitting}
                                    className={`w-full pl-11 pr-4 py-3 bg-white/5 border ${errors.email ? 'border-red-500/50 focus:border-red-500' : 'border-white/10 focus:border-blue-500/50'} rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed`}
                                />
                            </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                    disabled={isSubmitting}
                                    className={`w-full pl-11 pr-11 py-3 bg-white/5 border ${errors.password ? 'border-red-500/50 focus:border-red-500' : 'border-white/10 focus:border-blue-500/50'} rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed`}
                                />
                                <button
                                    type="button"
                                    onClick={() => setShowPassword(!showPassword)}
                                    disabled={isSubmitting}
                                    className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-500 hover:text-white transition-colors disabled:opacity-50"
                                >
